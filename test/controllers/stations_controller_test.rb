...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { latitude: @station.latitude, longitude: @station.longitude, name: @station.name }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { latitude: @station.latitude, longitude: @station.longitude, name: @station.name }
    assert_redirected_to station_path(assigns(:station))
  end
